#!/bin/bash
#SBATCH -J PCSI_0410_Lu_M_526-remap
#SBATCH -o ./%x.%j.%N.out
#SBATCH -D ./
...
nextflow run ${mocaseqDir}/main.nf -profile charliecloud -entry MAP -work-dir ${workingDir} --output_base ${projectDir}/input --genome_build.human GRCh38.p12 --custom_config_base ${mocaseqDir}/conf --custom_config_version mocaseq-lrz --input ${mocaseqDir}/input/remap/batch02-PCSI_0410_2.tsv -resume

#!/bin/bash
#SBATCH -J batch02-PCSI_0357-remap
#SBATCH -o ./%x.%j.%N.out
#SBATCH -D ./
...
# SLURM script for remapping sample group batch02-PCSI_0357 .bam files hg19 -> hg38.

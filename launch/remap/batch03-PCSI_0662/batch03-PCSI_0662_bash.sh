#!/bin/bash
#SBATCH -J batch03-PCSI_0662-remap
#SBATCH -o ./%x.%j.%N.out
#SBATCH -D ./
...
# SLURM script for remapping sample group batch03-PCSI_0662 .bam files hg19 -> hg38.
...
# specify sample
sample=PCSI_0662_Lv_M_526
bamDir=/dss/dssfs03/tumdss/pn72lo/pn72lo-dss-0006/projects/hPDAC/ICGC_PACA_CA_WGS//input/GRCh37_bam/batch03
bamName=EGAZ00001312059_COMPASS_wgs_PCSI_0662_Lv_M_526.bam
bamType="Tumor"
...
# specify sample
sample=PCSI_0662_Lv_M_5262
bamDir=/dss/dssfs02/lwp-dss-0001/pn29ya/pn29ya-dss-0000/projects/hPDAC/ICGC_PACA_CA_WGS//input/GRCh37_bam/batch03/EGAF00002251669
bamName=PCSI_0662_Lv_M_5262.bam
bamType="Tumor"
# submit subjob for sample remapping
srun --ntasks=1 --exclusive --mem 45568mb -J $sample -o ./%x.%j.%N.out ${mocaseqDir}/launch/ccc_remap_wrapper.sh -ccc $cccDir -wd $workingDir -m $mocaseqDir -bd $bamDir -bf $bamName -s $sample -rd $referencesDir -t $bamType > ${sample}-remap.out & 
sleep 4
...
# specify sample
sample=PCSI_0662_Ly_R
bamDir=/dss/dssfs02/lwp-dss-0001/pn29ya/pn29ya-dss-0000/projects/hPDAC/ICGC_PACA_CA_WGS//input/GRCh37_bam/batch03/EGAF00001709915
bamName=PCSI_0662_Ly_R.bam
bamType="Normal"
# submit subjob for sample remapping
srun --ntasks=1 --exclusive --mem 45568mb -J $sample -o ./%x.%j.%N.out ${mocaseqDir}/launch/ccc_remap_wrapper.sh -ccc $cccDir -wd $workingDir -m $mocaseqDir -bd $bamDir -bf $bamName -s $sample -rd $referencesDir -t $bamType > ${sample}-remap.out & 
sleep 4

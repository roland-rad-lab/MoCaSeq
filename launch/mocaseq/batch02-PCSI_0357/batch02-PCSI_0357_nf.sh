# MoCaSeq launch script for sample group batch02-PCSI_0357
 ...
 nextflow run ${repoDir}/main.nf -profile charliecloud,slurm -work-dir ${workDir} --output_base ${projectDir}/output --genome_build.human GRCh38.p12 --custom_config_version mocaseq-lrz --custom_config_base ${repoDir}/conf --input batch02-PCSI_0357.tsv

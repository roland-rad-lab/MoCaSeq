# MoCaSeq launch script for sample groupbatch02-PCSI_0410
 ...
 nextflow run ${repoDir}/main.nf -profile charliecloud,slurm -work-dir ${workDir} --output_base ${projectDir}/output --genome_build.human GRCh38.p12 --custom_config_version serial-std --custom_config_base ${repoDir}/conf --input batch02-PCSI_0410_Om_M.tsv

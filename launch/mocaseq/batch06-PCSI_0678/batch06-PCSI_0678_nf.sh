# MoCaSeq launch script for sample groupbatch06-PCSI_0678
...
nextflow run ${repoDir}/main.nf -profile charliecloud,slurm -with-report -with-timeline -work-dir ${workDir} --output_base ${projectDir}/output --genome_build.human GRCh38.p12 --custom_config_version serial-std --custom_config_base ${repoDir}/conf -N marcus.wagner@tum.de --input batch06-PCSI_0678.tsv

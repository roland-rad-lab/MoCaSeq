# MoCaSeq launch script for sample groupbatch02-ASHPC_0019
...
nextflow run ${repoDir}/main.nf -profile charliecloud,slurm -with-report -with-timeline -work-dir ${workDir} --output_base ${projectDir}/output --genome_build.human GRCh38.p12 --custom_config_version serial-std --custom_config_base ${repoDir}/conf --input batch02-ASHPC_0019.tsv

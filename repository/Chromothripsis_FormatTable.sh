...
getLines () {
	cut -f 1-2 $1 > part1
	grep -P -o 'CHR2=[0-9XY]{1,2};END=\d*' $1 | sed -r 's/CHR2=([0-9XY]*);END=([0-9]*)/\1\t\2/g' > part2
...
paste part1 part2 part3 part4 part5 part6 part7 part8 part9 > precise2.tab
...
paste part1 part2 part3 part4 part5 part6 part7 part8 part9 > imprecise2.tab

cat precise2.tab imprecise2.tab > breakpoints2.tab
#cat precise.tab imprecise.tab > breakpoints.tab
sort -k1,1V -k2,2n breakpoints2.tab | cat header - > "../"$name"/results/Delly/$name".breakpoints.tab

...
find $temp_dir/ftp-mouse.sanger.ac.uk/REL-1505-SNPs_Indels/strain_specific_vcfs/ -name "*.filter" | parallel --eta --load 80% --noswap 'bcftools sort {} -o {}.sort -O z'

find $temp_dir/ftp-mouse.sanger.ac.uk/REL-1505-SNPs_Indels/strain_specific_vcfs/ -name "*.filter.sort" | parallel --eta --load 80% --noswap 'tabix -p vcf {}'

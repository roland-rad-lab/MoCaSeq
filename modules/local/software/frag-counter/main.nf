...
attr (out,which="reads.corrected.raw.mean") <- mean (mcols (out)[,"reads.corrected"],na.rm=T)
mcols (out)[,"reads.corrected"] <- mcols (out)[,"reads.corrected"]/mean (mcols (out)[,"reads.corrected"],na.rm=T)

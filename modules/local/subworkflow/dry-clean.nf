...
workflow DRY_CLEAN {
	...
	ch_pon = Channel.of ([dir_pon.resolve ("${genome_build}.normal_table.rds"), dir_pon.resolve ("${genome_build}.germline.markers.rds"), dir_pon.resolve ("${genome_build}.detergent.rds") ]).first ()
